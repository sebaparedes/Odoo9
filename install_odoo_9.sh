...
echo -e "\n==== Download Localizacion ADHOC ===="
cd $OE_HOME
sudo su $OE_USER -c "git clone --depth 1 --single-branch --branch $OE_VERSION https://github.com/ingadhoc/odoo-argentina.git $OE_HOME_EXT/custom/addons/"
cd -
